...
import DataTableFacetedFilter from '@/components/tables/operations/DataTableFacetedFilter.vue'
import DataTableViewOptions from '@/components/tables/operations/DataTableViewOptions.vue'
			...
			<Popover>
				...
				<PopoverContent class="w-[450px] space-y-2">
					...
					<div class="flex w-full justify-between gap-2">
						...
						<DataTableFacetedFilter
							v-if="table.getColumn('subType')"
							:column="table.getColumn('subType')"
