...
<template>
    ...
    <div v-if="isLoading" class="absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2 z-10">
    ...
    <div v-if="isLoading" role="status" class="absolute top-0 left-0 w-full h-full bg-gray-200 rounded-lg opacity-85">
    </div>
	</div>
</template>